...
class Beat_The_Game_Message:
    ...
    def __init__(self):
        ...
        self.game_over_position = Position(properties.WINDOW_SIZE[0]/2 - 60, properties.WINDOW_SIZE[1]/2 - 100)
    ...
    def draw(self, screen, score, higher_scores):
        ...
        text_game_over = self.font_game_over.render('You Won!', True, colors.WHITE)
